            ...
            <div class="col-sm-8 col-lg-9 col-xs-12">
                <div class="single-post">
                    ...
                    <div class="post-details pull-left">
                        <h3><a href="blog-details.html">Music Improves Baby Brain</a></h3>
                        <ul class="date">
                ...
                <div class="single-post">
                    ...
                    <div class="post-details pull-left">
                        <h3><a href="blog-details.html">Caring for a Pet: Diabetic Kids</a></h3>
                        <ul class="date">
                            <li><a href="#"><i class="fa fa-clock-o" aria-hidden="true"></i>Tuesday, Feb 03, 2016</a></li>
                        </ul>
                        <ul class="author-tag">
                ...
                <div class="single-post">
                    ...
                    <div class="post-details pull-left">
                        <h3><a href="blog-details.html">Uncovers Ancient Ashkenaz</a></h3>
                        <ul class="date">
                            <li><a href="#"><i class="fa fa-clock-o" aria-hidden="true"></i>Tuesday, Feb 03, 2016</a></li>
                        </ul>
                        <ul class="author-tag">
                ...
                <div class="single-post">
                    ...
                    <div class="post-details pull-left">
                        <h3><a href="blog-details.html">Harsh Parenting Can Harm Child's Health</a></h3>
                        <ul class="date">
                            <li><a href="#"><i class="fa fa-clock-o" aria-hidden="true"></i>Tuesday, Feb 03, 2016</a></li>
                        </ul>
                        <ul class="author-tag">
