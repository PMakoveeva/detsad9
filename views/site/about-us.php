        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-xs-12 text-left">
                <div class="who-we-details">
                    ...
                    <p class="subtitle color">We Create Something New</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-7 col-xs-12">
                <div class="kids-mom-img">
                    <img alt="" src="images/about/kids-mom.jpg">
                </div>
            </div>
            <div class="col-sm-5 col-xs-12">
                <div class="atmosphere-details">
                    <h2 class="title-2">Atmosphere</h2>
                    <p class="subtitle color">Quality Children</p>
                    <article class="atmosphere-content">
                        <p>
...
<section class="activity-section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12 text-center">
                <h2 class="title-2">Our Activities</h2>
                <p class="subtitle color">Best Services for Kids</p>
            </div>
        </div>
        <div class="row">
...
<section class="team-section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12 text-center">
                <h2 class="title">Meet Our Staffs</h2>
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12 text-center">
                <div class="stuff-button">
                    <a class="primary-btn" href="#"><span>See all Staff</span></a>
                </div>
            </div>
        </div>
    </div>
